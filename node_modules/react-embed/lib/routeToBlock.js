...
var canPlay_1 = tslib_1.__importDefault(require("./blocks/react-simple-player/canPlay"));
var canPlay_2 = tslib_1.__importDefault(require("./blocks/react-player/canPlay"));
var canPlay_3 = tslib_1.__importDefault(require("./blocks/pdf/canPlay"));
...
var routeToBlock = function (blocks, parsed) {
    ...
    switch (hostname) {
        ...
        case 'codesandbox.io':
            ...
            return undefined;
        default:
            if ((0, canPlay_3.default)(url)) {
                return [blocks.pdf, ''];
            }
            else if ((0, canPlay_1.default)(url)) {
                return [blocks.simplePlayer, ''];
            }
            else if ((0, canPlay_2.default)(url)) {
