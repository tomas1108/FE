...
var Imgur = (function (_super) {
    ...
    Imgur.prototype.render = function () {
        ...
        return this.props.renderWrap(React.createElement("div", { style: tslib_1.__assign(tslib_1.__assign({}, blockStyle), { border: height ? '1px solid #E5E9F2' : '' }) },
            React.createElement("iframe", { scrolling: "no", frameBorder: "0", src: this.src(), style: tslib_1.__assign(tslib_1.__assign({}, iframeStyle), { height: height }) })));
    };
    return Imgur;
}(React.Component));
