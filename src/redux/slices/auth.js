...
export function NewPassword(formValues) {
  return async (dispatch, getState) => {
    ...
    await axios
      .post(
        "bechat-env.eba-csvanjsa.ap-southeast-1.elasticbeanstalk.com/auth/reset-password",
        {
          ...formValues,
        },
        {
...
export function ForgotPassword(formValues) {
  return async (dispatch, getState) => {
    ...
    await axios
      .post(
        "bechat-env.eba-csvanjsa.ap-southeast-1.elasticbeanstalk.com/auth/forgot-password",
        {
          ...formValues,
        },
        {
...
export function ChangePassowrd(formValues) {
  return async (dispatch, getState) => {
    ...
    await axios
      .post(
        "bechat-env.eba-csvanjsa.ap-southeast-1.elasticbeanstalk.com/auth/change-password",
        {
          ...formValues,
        },
        {
...
export function createGroup (formValues) {
  return async (dispatch, getState) => {
    await axios
    .post(
      "bechat-env.eba-csvanjsa.ap-southeast-1.elasticbeanstalk.com/user/create-group",
      {
        ...formValues,
      },
      {
...
export function LoginUser(formValues) {
  return async (dispatch, getState) => {
    ...
    await axios
      .post(
        "bechat-env.eba-csvanjsa.ap-southeast-1.elasticbeanstalk.com/auth/login",
        {
          ...formValues,
        },
        {
...
export function RegisterUser(formValues) {
  return async (dispatch, getState) => {
    ...
    await axios
      .post(
        "bechat-env.eba-csvanjsa.ap-southeast-1.elasticbeanstalk.com/auth/register",
        {
          ...formValues,
        },
        {
...
export function VerifyEmail(formValues) {
  return async (dispatch, getState) => {
    ...
    await axios
      .post(
        "bechat-env.eba-csvanjsa.ap-southeast-1.elasticbeanstalk.com/auth/verify",
        {
          ...formValues,
        },
        {
...
export const UpdateUserAvatar = (user_id, formData) => {
  return async (dispatch, getState) => {
    try {
      ...
      console.log("USER ID", user_id);
      const response = await axios.post(
        "bechat-env.eba-csvanjsa.ap-southeast-1.elasticbeanstalk.com/user/update-avatar",
        { _id: user_id, ...formData }, // Thêm user_id và dữ liệu từ form vào payload
        {
          headers: {
            "Content-Type": "application/json",
